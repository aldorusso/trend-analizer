...
export default function HeroDesarrolloWeb() {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      ...
                      <p className="inner-headline__text t-large t-bright loading__item">
                        Sitios web hermosos, rápidos y orientados a la
                        conversión construidos en WordPress o frameworks
                        modernos para fortalecer tu presencia online.
                      </p>
                    </div>
                  </div>
                </div>
                              ...
                              <div className="mxd-stats-cards__inner bg-base-tint radius-m padding-4">
                                <div className="mxd-counter">
                                  ...
                                  <p className="mxd-counter__descr t-140 t-bright">
                                    semanas de desarrollo para entregar tu
                                    proyecto web profesional y optimizado
                                  </p>
                                </div>
