...
export default function HeroMarketingIA() {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      ...
                      <p className="inner-headline__text t-large t-bright loading__item">
                        Campañas de marketing digital de alto rendimiento y soluciones de IA que maximizan tu ROI y automatizan procesos clave de tu negocio.
                      </p>
                    </div>
                  </div>
                </div>
                              ...
                              <div className="mxd-stats-cards__inner bg-base-tint radius-m padding-4">
                                <div className="mxd-counter">
                                  ...
                                  <p className="mxd-counter__descr t-140 t-bright">
                                    semanas para lanzar campañas de marketing optimizadas con IA y comenzar a ver resultados
                                  </p>
                                </div>
