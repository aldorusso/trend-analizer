...
export default function HeroSoftwareMedida() {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      ...
                      <p className="inner-headline__text t-large t-bright loading__item">
                        Desarrollo de sistemas complejos, SAAS y Backend
                        robustos que optimizan tu negocio con tecnología de
                        punta y arquitecturas escalables.
                      </p>
                    </div>
                  </div>
                </div>
                              ...
                              <div className="mxd-stats-cards__inner bg-base-tint radius-m padding-4">
                                <div className="mxd-counter">
                                  ...
                                  <p className="mxd-counter__descr t-140 t-bright">
                                    semanas para desarrollar tu solución de
                                    software personalizada y escalable
                                  </p>
                                </div>
