            ...
            <div className="mxd-sidebar mxd-grid-item">
              ...
              <div className="mxd-sidebar__widget bg-base-tint radius-m widget-about">
                ...
                <div className="widget__descr">
                  <p className="t-small">
                    Sumérgete en las últimas tendencias, descubre análisis
                    valiosos de la industria y explora consejos prácticos.
                  </p>
                </div>
              </div>
              ...
              <div className="mxd-sidebar__widget bg-base-tint radius-m widget-socials">
                ...
                <div className="widget__descr">
                  <p className="t-small">
                    ¡Síguenos y entérate de todas las novedades y contenido
                    interesante primero!
                  </p>
                </div>
