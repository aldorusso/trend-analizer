          ...
          <div className="container max-w-lg lg:max-w-950px xl:max-w-xl">
            ...
            >
              ...
              <div className="uc-navbar-center">
                <ul className="uc-navbar-nav gap-2 xl:gap-3 d-none lg:d-flex fs-6 fw-medium scrollSpyLinks">
              ...
              <div className="uc-navbar-right hstack gap-2 lg:gap-3">
                <div className="d-none xl:d-block">
                  <a
                    className="text-none fw-medium fs-7"
                ...
                <div className="d-none lg:d-block">
                  <Link className="text-none fw-medium fs-7" href={`/sign-in`}>
