    ...
    >
      ...
      >
        <div className="container max-w-xl">
          <div className={`uc-navbar min-h-64px lg:min-h-80px ${scrollingUp ? 'text-gray-900' : 'text-white'}`}>
            <div className="uc-navbar-left">
              <div className={`uc-logo ${scrollingUp ? 'text-dark' : 'text-white'}`}>
                <Link
                  className="panel text-none"
                  href={`/`}
                  style={{ width: 140 }}
                >
                  {/* Logo blanco cuando no es sticky (fondo oscuro), logo negro cuando es sticky (fondo blanco) */}
                  {scrollingUp ? (
                    <Image
                      alt="Kontaly"
