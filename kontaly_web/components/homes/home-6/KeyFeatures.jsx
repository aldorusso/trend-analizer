          ...
          <div className="section-inner panel vstack gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <p className="fs-4 lg:fs-3 xl:fs-2 max-w-lg mx-auto m-0">
                Sistema de <b>Tickets</b>, <b>Contratos</b> con firma electrónica,
                <b> Gestión de Gastos</b>, <b>Objetivos</b>, <b>Encuestas</b>,
                Base de Conocimientos y <b>Reportes Avanzados</b>.
              </p>
            </div>
            <div
              className="panel"
