...
export default function Blogs() {
  return (
    ...
    >
      <div className="section-outer panel pt-3 lg:pt-4 xl:pt-5 lg:mx-2 lg:rounded-2 bg-secondary dark:bg-tertiary-700">
              ...
              <div>
                <div className="heading vstack gap-2 justify-center items-center text-center panel">
                  ...
                  <p className="fs-6 xl:fs-5 opacity-70">
                    Consejos, noticias y actualizaciones sobre gestión empresarial
                  </p>
                </div>
              </div>
              <div>
