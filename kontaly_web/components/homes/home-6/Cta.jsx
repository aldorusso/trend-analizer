          ...
          <div className="section-inner vstack lg:hstack items-center gap-4 lg:gap-6 text-center ltr:lg:text-start rtl:lg:text-end flex-sm-column home-6-cta">
            ...
            >
              ...
              <p className="fs-5 my-0">
                Únete a miles de empresas que ya confían en Kontaly para gestionar sus operaciones
              </p>
              <div className="hstack gap-2 justify-center lg:justify-start mt-4">
                <a
                  href="/page-pricing"
                  className="btn btn-md btn-primary min-w-150px px-3"
                >
                ...
                <a
                  href="/page-contact"
                  className="btn btn-md btn-outline-gray-900 min-w-150px px-3"
                >
                  <span>Hablar con ventas</span>
                </a>
              </div>
              <p className="fs-7 text-black text-opacity-70 mt-2">
