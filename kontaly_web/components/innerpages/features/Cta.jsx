        ...
        <div className="container max-w-xl">
          <div className="section-inner panel p-4 sm:p-6 xl:p-8 rounded-2 bg-secondary dark:bg-gray-800 overflow-hidden">
            <div className="vstack gap-2 max-w-550px items-center lg:items-start m-auto lg:m-0 text-center lg:text-start rtl:lg:text-end">
              ...
              <div className="vstack sm:hstack justify-center lg:justify-start gap-2 mt-1 lg:mt-2">
                <a
                  href="https://www.kontaly.com/authentication/register"
                  target="_blank"
                ...
                <a
                  href="/page-contact"
                  className="btn btn-md lg:btn-lg btn-outline-primary"
                >
                  Hablar con ventas
                </a>
              </div>
