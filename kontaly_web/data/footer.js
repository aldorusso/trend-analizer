export const footerLinks = [
  ...
  {
    links: [
      { href: "/page-colaboradores", label: "Colaboradores" },
      { href: "/blog", label: "Blog" },
      { href: "/page-contact", label: "Ayuda" },
      { href: "/page-legal", label: "Centro legal" },
    ],
  },
  {
    links: [
      { href: "/page-privacy", label: "Privacidad" },
      { href: "/page-terms", label: "Términos de servicio" },
      { href: "/page-cookies", label: "Cookies" },
...
export const footerLinks2 = [
  {
    header: "Inner pages",
    links: [
      { href: "/page-caracteristicas", label: "Características" },
...
export const footerLinks3 = [
  {
    ...
    links: [
      ...
      { href: "/page-contact", label: "Precios" },
...
export const footerLinks4 = [
  {
    ...
    links: [
      ...
      { text: "Colaboradores", href: "/page-career", isLink: true },
    ],
  },
  {
    title: "Empresa",
    links: [
      { text: "Contacto", href: "/page-contact", isLink: true },
      { text: "Ayuda", href: "#" },
    ],
  },
  {
    title: "Legal",
    links: [
      { text: "Privacidad", href: "/page-privacy", isLink: true },
      { text: "Términos", href: "/page-terms", isLink: true },
      { text: "Cookies", href: "#" },
    ],
    extraClass: "d-none lg:d-block",
  },
